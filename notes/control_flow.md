...
[Control Flow - The Swift Programming Language (Swift 5.6)](https://docs.swift.org/swift-book/LanguageGuide/ControlFlow.html)
...
This behavior removes the need for the array bounds check seen in the `while` loop version of the game described earlier.
...
case (_, 0): // use the underscore character (_), also known as the wildcard pattern, to match any possible value.
